...
#pragma endregion
	...
	if (ThemeColors)
	{
		if (CurrentOpt == 0)
		{
			...
			logs::SendMessageDebug(L"Default Theme Color Set!", UI::MCTextColors::Blue);
		}

		if (CurrentOpt == 1)
		{
			UI::Settings::ThemeColors = "WHITE";
			logs::SendMessageDebug(L"White Theme Color Set!", UI::MCTextColors::White);
		}

		if (CurrentOpt == 2)
		{
			UI::Settings::ThemeColors = "PINK";
			logs::SendMessageDebug(L"Pink Theme Color Set!", UI::MCTextColors::LightPurple);
		}

		if (CurrentOpt == 3)
		{
			UI::Settings::ThemeColors = "RED";
			logs::SendMessageDebug(L"Red Theme Color Set!", UI::MCTextColors::Red);
		}

		if (CurrentOpt == 4)
		{
			UI::Settings::ThemeColors = "ORANGE";
			logs::SendMessageDebug(L"Orange Theme Color Set!", UI::MCTextColors::Gold);
		}

		if (CurrentOpt == 5)
		{
			UI::Settings::ThemeColors = "CYAN";
			logs::SendMessageDebug(L"Cyan Theme Color Set!", UI::MCTextColors::Aqua);
		}

		if (CurrentOpt == 6)
		{
			UI::Settings::ThemeColors = "GREEN";
			logs::SendMessageDebug(L"Green Theme Color Set!", UI::MCTextColors::DarkGreen);
		}

		if (CurrentOpt == 7)
		{
			UI::Settings::ThemeColors = "LIME";
			logs::SendMessageDebug(L"Lime Theme Color Set!", UI::MCTextColors::Green);
		}

		if (CurrentOpt == 8)
		{
			UI::Settings::ThemeColors = "YELLOW";
			logs::SendMessageDebug(L"Yellow Theme Color Set!", UI::MCTextColors::Yellow);
		}

		if (CurrentOpt == 9)
		{
			UI::Settings::ThemeColors = "PURPLE";
			logs::SendMessageDebug(L"Purple Theme Color Set!", UI::MCTextColors::LightPurple);
		}
		...
		if (CurrentOpt == 10)
		{
			if (!UI::Settings::Rainbow)
			{
				...
				logs::SendMessageDebug(L"Rainbow Theme Color Set!", Rainbow);
			}
			else
			{
	...
	if (MiniGamePage)
	{
		...
		if (CurrentOpt == 10)
		{
			if (!InventoryCreaTumbleActive)
			{
				...
				InventoryCreaTumbleActive = true;
			}
			else
			{
				//Offsets::INVENTORY_CREATIVE_TUMBLE(false);
				InventoryCreaTumbleActive = false;
			}
		}
