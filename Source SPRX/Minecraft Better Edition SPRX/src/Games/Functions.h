...
RGBTEXT MenuColour2 = { 0, 0, 90 };

void DoRainbowColor1()
{
...
void DoRainbowColor2()
{
	if (RainbowTime < mc->gameTime)
	{
		...
		RainbowRED2 = MenuColour2.G;
		RainbowRED2 = MenuColour2.B;
...
void DrawGradientBorder(float x, float y, float w, float h, int* color1, int* color2, int* color3, int borderSize)
{
	DrawGradientRectangle(x - 1, y - 1, w + 2, h + 2, color1, color2, true);
