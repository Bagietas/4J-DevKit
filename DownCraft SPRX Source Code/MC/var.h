...
bool ReverseKnockback = false;
bool DropFarItems = false;
bool MaxXPLevel = false;
bool WaterJump = false;
bool DriftBoat = false;

//Host Options 1
bool StopArrows = false;
bool RemoveArrows = false;
bool PotionsFlying = false;
bool PotionsNoGravity = false;
bool InfinitePickupItems = false;
bool MaxPickupItems = false;
bool InfiniteBlocks = false;
bool BurnInWater = false;
bool RemoveFire = false;
bool CreativeSlot = false;
bool SurvivalSlot = false;
bool KillSpawnEntity = false;
bool StopBlockGravity = false;
