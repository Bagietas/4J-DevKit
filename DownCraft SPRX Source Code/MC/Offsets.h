...
//minecraft custom block by NyTekCFW
#define Block_Entry 0x14C8924
/*
int block_numbers;
int number_of_blocks()
{
	...
	_sys_printf("block numbers : %i\n", block_numbers);
	return block_numbers;
}
int block_gap[] = { 0xA0 };
char targetname[32], templatesname[32];
char* get_name_block(int who, char what[])
{
	int jump = 0;
	int base = (*(int*)(Block_Entry + (who * 4))) + block_gap[who];
	for (int a = 0; a < 64; a++)
	{
		if (*(unsigned char*)(base + a) != 0x00 && *(unsigned char*)(base + a + 0x1) != 0x00)
		{
			what[jump] = *(unsigned char*)base;
			jump++;
		}
		else if (*(unsigned char*)base == 0x00 && *(unsigned char*)base + 1 == 0x00)
		{
			a = 64;
		}
	}
...
void Patch_block()
{
	*(int*)(Block_Entry + (targetname[32] * 4)) = *(int*)(Block_Entry + (templatesname[32] * 4));
}
*/
...
namespace Offsets
{
	void ChangeBlocks()
	{
		*(int*)(SelectedBlock) = *(int*)(changedblock); //patch le block selectionner par le block desirer
	}
	...
	void GOD_MODE(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x4B2020 = 0xFC80F890;
			SetNotify(L"God Mode: ON");
		}
		else
		{
			*(int*)0x4B2020 = 0xFC20F890;
			SetNotify(L"God Mode: OFF");
		}
	}

	void DEMI_GOD_MODE(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x3A4064 = 0xFF408890;
			SetNotify(L"Demi God Mode: ON");
		}
		else
		{
			*(int*)0x3A4064 = 0xFF400890;
			SetNotify(L"Demi God Mode: OFF");
		}
	}
	...
	void CRITICAL_HIT(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x1AC410 = 0xFFE02890;
			SetNotify(L"Critical Hit: ON");
		}
		else
		{
			*(int*)0x1AC410 = 0xFFE00890;
			SetNotify(L"Critical Hit: OFF");
		}
	}

	void INSTANT_KILL_ALL(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x3A4064 = 0xFF402890;
			SetNotify(L"Instant Kill All: ON");
		}
		else
		{
			*(int*)0x3A4064 = 0xFF400890;
			SetNotify(L"Instant Kill All: OFF");
		}
	}

	void KILL_IN_CREATIVE(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x226168 = 0x4086001C;
			SetNotify(L"Kill In Crea: ON");
		}
		else
		{
			*(int*)0x226168 = 0x4186001C;
			SetNotify(L"Kill In Crea: OFF");
		}
	}

	void KILL_IN_FIRE(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x226168 = 0x4086001C;
			SetNotify(L"Kill In Fire: ON");
		}
		else
		{
			*(int*)0x226168 = 0x4186001C;
			SetNotify(L"Kill In Fire: OFF");
		}
	}

	void NO_DAMAGE_HIT(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x3A3FF0 = 0xFF000000;
			SetNotify(L"No Damage Hit: ON");
		}
		else
		{
			*(int*)0x3A3FF0 = 0x3F000000;
			SetNotify(L"No Damage Hit: OFF");
		}
	}
	...
	void ANTI_KNOCKBACK(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x3A4018 = 0x00CCCCCD;
			SetNotify(L"Anti Knockback: ON");
		}
		else
		{
			*(int*)0x3A4018 = 0x3ECCCCCD;
			SetNotify(L"Anti Knockback: OFF");
		}
	}

	void REVERSE_KNOCKBACK(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0xBF };
			sys_dbg_write_process_memory(0x003A4018, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x003A4018, &HEX, sizeof(HEX));
			SetNotify(L"Reverse Knockback: ON");
		}
		else
		{
			char HEX[] = { 0x3E };
			sys_dbg_write_process_memory(0x003A4018, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x003A4018, &HEX, sizeof(HEX));
			SetNotify(L"Reverse Knockback: OFF");
		}
	}

	void DROP_ITEMS_FAR(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0xFF };
			sys_dbg_write_process_memory(0x014C6881, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x014C6881, &HEX, sizeof(HEX));
			SetNotify(L"Drop Items Far: ON");
		}
		else
		{
			char HEX[] = { 0x80 };
			sys_dbg_write_process_memory(0x014C6881, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x014C6881, &HEX, sizeof(HEX));
			SetNotify(L"Drop Items Far: OFF");
		}
	}

	void MAX_LEVEL_XP(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x4B0094 = 0x7CA51014;
			SetNotify(L"Max Level XP: ON");
		}
		else
		{
			*(int*)0x4B0094 = 0x7CA52014;
			SetNotify(L"Max Level XP: OFF");
		}
	}
	...
	void WATER_JUMP(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x3ABD68 = 0x3FFF9999;
			SetNotify(L"Water Jump: ON");
		}
		else
		{
			*(int*)0x3ABD68 = 0x3FE99999;
			SetNotify(L"Water Jump: OFF");
		}
	}
	...
	void STOP_ARROWS(bool toggle)
	{
		if (toggle)
		{
			*(int*)0xFB55C = 0x80400000;
			SetNotify(L"Stop Arrows: ON");
		}
		else
		{
			*(int*)0xFB55C = 0x40400000;
			SetNotify(L"Stop Arrows: OFF");
		}
	}

	void REMOVE_ARROWS(bool toggle)
	{
		if (toggle)
		{
			*(int*)0xFB644 = 0x41820020;
			SetNotify(L"Remove Arrows: ON");
		}
		else
		{
			*(int*)0xFB644 = 0x40820020;
			SetNotify(L"Remove Arrows: OFF");
		}
	}

	void POTIONS_FLYING(bool toggle)
	{
		if (toggle)
		{
			*(int*)0x0065FB60 = 0x2D4CCCCD;
			SetNotify(L"Potions Flying: ON");
		}
		else
		{
			*(int*)0x0065FB60 = 0x3D4CCCCD;
			SetNotify(L"Potions Flying: OFF");
		}
	}

	void POTIONS_NO_GRAVITY(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x4D };
			sys_dbg_write_process_memory(0x0065FB60, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x0065FB60, &HEX, sizeof(HEX));
			SetNotify(L"Potions No Gravity: ON");
		}
		else
		{
			char HEX[] = { 0x3D };
			sys_dbg_write_process_memory(0x0065FB60, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x0065FB60, &HEX, sizeof(HEX));
			SetNotify(L"Potions No Gravity: OFF");
		}
	}

	void INFINITE_PICKUP_ITEMS(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x00 };
			sys_dbg_write_process_memory(0x00224B13, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00224B13, &HEX, sizeof(HEX));
			SetNotify(L"Inf Pickup Items: ON");
		}
		else
		{
			char HEX[] = { 0x01 };
			sys_dbg_write_process_memory(0x00224B13, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00224B13, &HEX, sizeof(HEX));
			SetNotify(L"Inf Pickup Items: OFF");
		}
	}

	void MAX_PICKUP_ITEMS(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x41 };
			sys_dbg_write_process_memory(0x00310AD4, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00310AD4, &HEX, sizeof(HEX));
			SetNotify(L"Max Pickup Items: ON");
		}
		else
		{
			char HEX[] = { 0x40 };
			sys_dbg_write_process_memory(0x00310AD4, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00310AD4, &HEX, sizeof(HEX));
			SetNotify(L"Max Pickup Items: OFF");
		}
	}

	void INFINITE_BLOCKS(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x01 };
			sys_dbg_write_process_memory(0x0010673F, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x0010673F, &HEX, sizeof(HEX));
			SetNotify(L"Infinite Blocks: ON");
		}
		else
		{
			char HEX[] = { 0x00 };
			sys_dbg_write_process_memory(0x0010673F, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x0010673F, &HEX, sizeof(HEX));
			SetNotify(L"Infinite Blocks: OFF");
		}
	}

	void BURN_IN_WATER(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x41 };
			sys_dbg_write_process_memory(0x00225EA8, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00225EA8, &HEX, sizeof(HEX));
			SetNotify(L"Burn In Water: ON");
		}
		else
		{
			char HEX[] = { 0x40 };
			sys_dbg_write_process_memory(0x00225EA8, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00225EA8, &HEX, sizeof(HEX));
			SetNotify(L"Burn In Water: OFF");
		}
	}

	void REMOVE_FIRE(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x40 };
			sys_dbg_write_process_memory(0x00225E80, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00225E80, &HEX, sizeof(HEX));
			SetNotify(L"Remove Fire: ON");
		}
		else
		{
			char HEX[] = { 0x41 };
			sys_dbg_write_process_memory(0x00225E80, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00225E80, &HEX, sizeof(HEX));
			SetNotify(L"Remove Fire: OFF");
		}
	}

	void CREATIVE_SLOT(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x01 };
			sys_dbg_write_process_memory(0x002F034B, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x002F034B, &HEX, sizeof(HEX));
			char HEX1[] = { 0x00 };
			sys_dbg_write_process_memory(0x002F039B, &HEX1, sizeof(HEX1));
			sys_dbg_write_process_memory_ps3mapi(0x002F039B, &HEX1, sizeof(HEX1));
			SetNotify(L"Creative Slot: ON");
		}
		else
		{
			char HEX[] = { 0x00 };
			...
			sys_dbg_write_process_memory(0x002F039B, &HEX1, sizeof(HEX1));
			sys_dbg_write_process_memory_ps3mapi(0x002F039B, &HEX1, sizeof(HEX1));
			SetNotify(L"Creative Slot: OFF");
		}
	}

	void SURVIVAL_SLOT(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x01 };
			sys_dbg_write_process_memory(0x002F037B, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x002F037B, &HEX, sizeof(HEX));
			char HEX1[] = { 0x00 };
			sys_dbg_write_process_memory(0x002F036B, &HEX1, sizeof(HEX1));
			sys_dbg_write_process_memory_ps3mapi(0x002F036B, &HEX1, sizeof(HEX1));
			SetNotify(L"Survival Slot: ON");
		}
		else
		{
			char HEX[] = { 0x00 };
			...
			sys_dbg_write_process_memory(0x002F036B, &HEX1, sizeof(HEX1));
			sys_dbg_write_process_memory_ps3mapi(0x002F036B, &HEX1, sizeof(HEX1));
			SetNotify(L"Survival Slot: OFF");
		}
	}

	void KILL_SPAWN_ENTITY(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x48 };
			sys_dbg_write_process_memory(0x005BF34E, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x005BF34E, &HEX, sizeof(HEX));
			SetNotify(L"Kill Spawn Entity: ON");
		}
		else
		{
			char HEX[] = { 0x08 };
			sys_dbg_write_process_memory(0x005BF34E, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x005BF34E, &HEX, sizeof(HEX));
			SetNotify(L"Kill Spawn Entity: OFF");
		}
	}

	void STOP_BLOCKS_GRAVITY(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0xFF };
			sys_dbg_write_process_memory(0x00246A2C, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00246A2C, &HEX, sizeof(HEX));
			SetNotify(L"No Blocks Gravity: ON");
		}
		else
		{
			char HEX[] = { 0x3F };
			sys_dbg_write_process_memory(0x00246A2C, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00246A2C, &HEX, sizeof(HEX));
			SetNotify(L"No Blocks Gravity: OFF");
		}
	}

	void NO_DELAY_HIT(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x3F, 0xFF };
		...
		else
		{
			...
			sys_dbg_write_process_memory(0x003A3FF0, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x003A3FF0, &HEX, sizeof(HEX));
			SetNotify(L"No Delay Hit: OFF");
		}
	}

	void BYPASS_MAX_ITEMS(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x41 };
			sys_dbg_write_process_memory(0x00310AFC, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00310AFC, &HEX, sizeof(HEX));
			SetNotify(L"Bypass Max Items: ON");
		}
		else
		{
			char HEX[] = { 0x40 };
			sys_dbg_write_process_memory(0x00310AFC, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00310AFC, &HEX, sizeof(HEX));
			SetNotify(L"Bypass Max Items: OFF");
		}
	}

	void INFINITE_FOOD(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x00 };
	...
	void KILL_ON_RESPAWN(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x4E, 0x80, 0x00, 0x20 };
			sys_dbg_write_process_memory(0x003A8678, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x003A8678, &HEX, sizeof(HEX));
			SetNotify(L"Kill On Respawn: ON");
		}
		else
		{
			...
			sys_dbg_write_process_memory(0x003A8678, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x003A8678, &HEX, sizeof(HEX));
			SetNotify(L"Kill On Respawn: OFF");
		}
	}
	...
	void FREEZE_ENTITY(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x4E, 0x80, 0x00, 0x20 };
	...
	void STOP_ENDERMAN_TP(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x4E, 0x80, 0x00, 0x20 };
			sys_dbg_write_process_memory(0x003B30A8, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x003B30A8, &HEX, sizeof(HEX));
			SetNotify(L"Stop Enderman TP: ON");
		}
		else
		{
			...
			sys_dbg_write_process_memory(0x003B30A8, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x003B30A8, &HEX, sizeof(HEX));
			SetNotify(L"Stop Enderman TP: OFF");
		}
	}

	void IGNORING_PRESSURE(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x38, 0x60, 0x00, 0x01 };
			sys_dbg_write_process_memory(0x00237BC8, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00237BC8, &HEX, sizeof(HEX));
			SetNotify(L"Ignoring Pressure: ON");
		}
		else
		{
			...
			sys_dbg_write_process_memory(0x00237BC8, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00237BC8, &HEX, sizeof(HEX));
			SetNotify(L"Ignoring Pressure: OFF");
		}
	}

	void ALL_ENCHANT(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x10 };
		...
		else
		{
			...
			sys_dbg_write_process_memory(0x00218A4F, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00218A4F, &HEX, sizeof(HEX));
			SetNotify(L"All Enchant: OFF");
		}
	}

	void ITEMS_ON_HEAD(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x40 };
			sys_dbg_write_process_memory(0x00428704, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00428704, &HEX, sizeof(HEX));
			SetNotify(L"Items On Head: ON");
		}
		else
		{
			char HEX[] = { 0x41 };
			sys_dbg_write_process_memory(0x00428704, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x00428704, &HEX, sizeof(HEX));
			SetNotify(L"Items On Head: OFF");
		}
	}

	void STOP_BOAT(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x41 };
			sys_dbg_write_process_memory(0x000E0F90, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x000E0F90, &HEX, sizeof(HEX));
			SetNotify(L"Stop Boat: ON");
		}
		else
		{
			char HEX[] = { 0x40 };
			sys_dbg_write_process_memory(0x000E0F90, &HEX, sizeof(HEX));
			sys_dbg_write_process_memory_ps3mapi(0x000E0F90, &HEX, sizeof(HEX));
			SetNotify(L"Stop Boat: OFF");
		}
	}

	void NO_WEB(bool toggle)
	{
		if (toggle)
		{
			char HEX[] = { 0x00 };
			sys_dbg_write_process_memory(0x00234F9F, &HEX, sizeof(HEX));	
			sys_dbg_write_process_memory_ps3mapi(0x00234F9F, &HEX, sizeof(HEX));
			SetNotify(L"No Web: ON");
		}
		else
		{
			char HEX[] = { 0x01 };
